...
type JobIdentityInitParameters struct {
...
type JobIdentityObservation struct {
...
type JobIdentityParameters struct {
...
type JobInitParameters struct {
	...
	Identity *JobIdentityInitParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	Registry []JobRegistryInitParameters `json:"registry,omitempty" tf:"registry,omitempty"`
	...
	Secret []JobSecretInitParameters `json:"secret,omitempty" tf:"secret,omitempty"`
	...
	Template *JobTemplateInitParameters `json:"template,omitempty" tf:"template,omitempty"`
...
type JobObservation struct {
	...
	// A identity block as defined below.
	Identity *JobIdentityObservation `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// One or more registry blocks as defined below.
	Registry []JobRegistryObservation `json:"registry,omitempty" tf:"registry,omitempty"`
	...
	// One or more secret blocks as defined below.
	Secret []JobSecretObservation `json:"secret,omitempty" tf:"secret,omitempty"`
	...
	// A template block as defined below.
	Template *JobTemplateObservation `json:"template,omitempty" tf:"template,omitempty"`
...
type JobParameters struct {
	...
	// A identity block as defined below.
	// +kubebuilder:validation:Optional
	Identity *JobIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// One or more registry blocks as defined below.
	// +kubebuilder:validation:Optional
	Registry []JobRegistryParameters `json:"registry,omitempty" tf:"registry,omitempty"`
	...
	// One or more secret blocks as defined below.
	// +kubebuilder:validation:Optional
	Secret []JobSecretParameters `json:"secret,omitempty" tf:"secret,omitempty"`
	...
	// A template block as defined below.
	// +kubebuilder:validation:Optional
	Template *JobTemplateParameters `json:"template,omitempty" tf:"template,omitempty"`
...
type JobRegistryInitParameters struct {
...
type JobRegistryObservation struct {
...
type JobRegistryParameters struct {
...
type JobSecretInitParameters struct {
...
type JobSecretObservation struct {
...
type JobSecretParameters struct {
...
type JobTemplateInitParameters struct {
...
// Job is the Schema for the Jobs API. Manages a Container App Job.
